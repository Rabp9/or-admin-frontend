 ...
 */
angular.module('tuplastAdminApp')
.controller('ProductosAddCtrl', ["$scope", "ProductosService", "$uibModalInstance", function ($scope, ProductosService, $uibModalInstance) {
    $scope.producto = {};
    $scope.methods = {};
 ...
 */
angular.module('tuplastAdminApp')
.controller('ProductosEditCtrl', ["$scope", "producto", "$uibModalInstance", "ProductosService", function ($scope, producto, $uibModalInstance, ProductosService) {
    $scope.loading = false;
 ...
 */
angular.module('tuplastAdminApp')
.controller('ClientesAddCtrl', ["$scope", "$uibModalInstance", "ClientesService", function ($scope, $uibModalInstance, ClientesService) {
    $scope.cliente = {};
    $scope.tmp_path = angular.module('tuplastAdminApp').path_location + 'tmp'; 
    $scope.loading = false;
 ...
 */
angular.module('tuplastAdminApp')
.controller('ClientesEditCtrl', ["$scope", "cliente", "$uibModalInstance", "ClientesService", function ($scope, cliente, $uibModalInstance, ClientesService) {
